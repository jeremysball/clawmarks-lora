...
def _focus_list(data, context):
    ...
    return f'<section><h2>Open Foci</h2><p class="sub">Explore keeps the choice explicit. No Focus is selected automatically.</p><ul class="focus-list" aria-label="Open Foci">{rows}</ul><div class="focus-actions"><a class="raised-control" href="{_esc(context_url("/map.html", context, False))}">Create from Map</a><a class="raised-control" href="{_esc(context_url("/coverage.html", context, False))}">Create from Coverage</a></div></section>'
