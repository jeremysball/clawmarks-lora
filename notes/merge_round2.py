...
Reuses notes/build_solution_map.py's cached embeddings (solution_map_final_embs.pt) for round
...
Run: python3 notes/merge_round2.py
...
SWEEP2_DIR = f"{SC}/notes/uncanny_sweep2"
