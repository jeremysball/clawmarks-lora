...
Depends on notes/build_solution_map.py's output (solution_map_data.json), which does the actual
DINOv2 re-embedding and UMAP fit; this script only lays out the already-computed points.

Run after solution_map_data.json exists: python3 notes/build_map_view.py
"""
import json, os, sys
