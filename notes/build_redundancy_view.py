...
Depends on notes/build_solution_map.py's similarity_scored.json (top-16 neighbors WITH cosine
...
Run after similarity_scored.json exists: python3 notes/build_redundancy_view.py
"""
import json, os, sys
