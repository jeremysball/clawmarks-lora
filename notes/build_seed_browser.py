...
draw from. The search driver (run_uncanny_allnight2.py) already calls out to GPT-5.5 for fresh
...
Run: python3 notes/build_seed_browser.py
"""
import os, sys

sys.path.insert(0, os.path.dirname(__file__))
from shared_ui import (
    nav_bar_html, TOPNAV_CSS, MOBILE_BASE_CSS, SCROLLNAV_JS, write_scrollnav_asset,
